    ...
    rules: [
      ...
      { type: "field", ip: ["8.8.8.8", "8.8.4.4", "1.1.1.1", "1.0.0.1"], outboundTag: "proxy" },
      {
        ...
        domain: [
          ...
          "geosite:yandex",
          "geosite:mailru",
          "domain:tbank.ru", "domain:tinkoff.com", "domain:tinkoff.ru",
          "domain:sber.ru", "domain:sberbank.ru", "domain:sbermarket.ru",
          "domain:alfabank.ru", "domain:alfaclick.ru",
          ...
          "domain:modulbank.ru",
          "domain:delo.ru",
          "domain:nalog.gov.ru", "domain:nalog.ru", "domain:lknpd.nalog.ru",
          "domain:gosuslugi.ru",
          "domain:mos.ru",
          ...
          "domain:tutu.ru",
          "domain:rzd.ru",
          "domain:ntv.ru", "domain:ntvplus.ru",
          "domain:1tv.ru",
          "domain:vgtrk.ru", "domain:russia.tv", "domain:smotrim.ru",
          "domain:ctc.ru", "domain:tnt-online.ru", "domain:rentv.ru",
          "domain:5-tv.ru",
          "domain:match.tv", "domain:matchtv.ru",
          "domain:tv-culture.ru",
          "domain:ivi.ru",
          "domain:okko.tv",
          "domain:start.ru",
          "domain:wink.ru",
          ...
          "domain:tele2.ru",
          "domain:yota.ru",
          "domain:gis-zhkh.ru", "domain:dom.gosuslugi.ru",
          "domain:reformagkh.ru",
          "domain:pik.ru", "domain:samolet.ru", "domain:lsr.ru",
          "domain:etagi.com",
          "domain:youla.ru",
          ...
          "domain:citilink.ru",
          "domain:lamoda.ru",
          "domain:magnit.ru", "domain:lenta.com", "domain:perekrestok.ru", "domain:sbermarket.ru",
          "domain:samokat.ru", "domain:lavka.yandex.ru",
          "domain:dodo.ru", "domain:dodopizza.ru"
        ],
        outboundTag: "direct",
      },
