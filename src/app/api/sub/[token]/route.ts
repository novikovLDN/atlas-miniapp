...
const BASIC_CONFIGS: ServerConfig[] = [
  ...
  { ip: "62.84.123.132",  port: 443,  sni: "ads.x5.ru",      fp: "chrome", type: "tcp", flow: true, sid: "a1b2c3d4", pbk: "4km41B5xZ3iJ4Z_VJ9WazIg3s_Pf2qSDmm55Yf28akg", name: "🇷🇺 White List #1 ⚪️ Резерв LTE" },
  { ip: "62.84.123.132",  port: 8443, sni: "yandex.ru",      fp: "chrome", type: "tcp", flow: true, sid: "b2c3d4e5", pbk: "WHlvowEffIH0xWQC7hTbYAn1PqcLCHSHGkkW2fWI2Rk", name: "🇷🇺 White List #2 ⚪️ Резерв 5G" },
];
