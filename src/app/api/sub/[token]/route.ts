...
const BASIC_CONFIGS: ServerConfig[] = [
  ...
  { ip: "83.166.248.199", port: 443,  sni: "eh.vk.com",      fp: "chrome",  type: "tcp", flow: true, sid: "a1b2c3d4", pbk: "yi6gAOGANFG3ni7TJsRgZxLya_21IjjKv2wi-pFBGTI", name: "🇷🇺 White List МТС + Билайн ⚡️" },
  { ip: "83.166.248.199", port: 8443, sni: "max.ru",         fp: "firefox", type: "tcp", flow: true, sid: "b2c3d4e5", pbk: "kxU9p891TeiCjPdIuyIEKf2A_kbPzi32XLG3UiInN38", name: "🇷🇺 White List Т2 + Операторы ⚡️" },
];
